            ...
            if (isValid) {
                ...
                exists(user, doesExist -> {
                    ...
                    if (!doesExist) {
                        final Listeners.AnswerListener successListener = new Listeners.AnswerListener() {
                            ...
                            public void onAnswerRetrieved() {
                                if (++count == 2) {
                                    ...
                                    relationship.setFollowingUser(user);
                        ...
                        DAOHandler.getFirebaseDatabase("users/" + user.getKey() + NODE_FOLLOWERS)
    ...
    public UserFollowerDAO delete(@NonNull final String key,
        ...
        isNodeValid(userNode, retrievedBoolean -> {
            if (retrievedBoolean) {
                ...
                final Query query = getReference().orderByChild("userKey").equalTo(key);
