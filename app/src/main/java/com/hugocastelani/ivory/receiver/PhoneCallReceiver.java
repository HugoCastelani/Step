package com.hugocastelani.ivory.receiver;
...
import com.hugocastelani.ivory.database.dao.wide.DenunciationDAO;
import com.hugocastelani.ivory.database.dao.wide.UserPhoneDAO;
import com.hugocastelani.ivory.database.domain.Denunciation;
...
public class PhoneCallReceiver extends BroadcastReceiver {
    ...
    private void sendNotification(@NonNull final Phone phone, @NonNull final Context context) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                .setSmallIcon(R.drawable.intro_about)
